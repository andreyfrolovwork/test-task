...
Executing (default): CREATE TABLE IF NOT EXISTS "passport3" ("id"  SERIAL UNIQUE , "series" VARCHAR(255), "number" VARCHAR(255), "giver" VARCHAR(255), "dateIssued" DATE, "createdAt" 
TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "destroyTime" TIMESTAMP WITH TIME ZONE, PRIMARY KEY ("id"));
Executing (default): SELECT i.relname AS name, ix.indisprimary AS primary, ix.indisunique AS unique, ix.indkey AS indkey, array_agg(a.attnum) as column_indexes, array_agg(a.attname) 
AS column_names, pg_get_indexdef(ix.indexrelid) AS definition FROM pg_class t, pg_class i, pg_index ix, pg_attribute a WHERE t.oid = ix.indrelid AND i.oid = ix.indexrelid AND a.attrelid = t.oid AND t.relkind = 'r' and t.relname = 'passport3' GROUP BY i.relname, ix.indexrelid, ix.indisprimary, ix.indisunique, ix.indkey ORDER BY i.relname;
Executing (default): CREATE TABLE IF NOT EXISTS "testAdress3" ("id"  SERIAL UNIQUE , "zipCode" VARCHAR(255), "country" VARCHAR(255), "region" VARCHAR(255), "city" VARCHAR(255), "street" VARCHAR(255), "house" VARCHAR(255), "apartment" VARCHAR(255), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "destroyTime" TIMESTAMP WITH TIME ZONE, PRIMARY KEY ("id"));
Executing (default): SELECT i.relname AS name, ix.indisprimary AS primary, ix.indisunique AS unique, ix.indkey AS indkey, array_agg(a.attnum) as column_indexes, array_agg(a.attname) 
AS column_names, pg_get_indexdef(ix.indexrelid) AS definition FROM pg_class t, pg_class i, pg_index ix, pg_attribute a WHERE t.oid = ix.indrelid AND i.oid = ix.indexrelid AND a.attrelid = t.oid AND t.relkind = 'r' and t.relname = 'testAdress3' GROUP BY i.relname, ix.indexrelid, ix.indisprimary, ix.indisunique, ix.indkey ORDER BY i.relname;
Executing (default): SELECT t.typname enum_name, array_agg(e.enumlabel ORDER BY enumsortorder) enum_value FROM pg_type t JOIN pg_enum e ON t.oid = e.enumtypid JOIN pg_catalog.pg_namespace n ON n.oid = t.typnamespace WHERE n.nspname = 'public' AND t.typname='enum_client3_typeEducation' GROUP BY 1
Executing (default): 
CREATE TABLE IF NOT EXISTS "client3" (
    "id" VARCHAR(255) , 
    "name" VARCHAR(255), 
    "surname" VARCHAR(255), 
    "patronymic" VARCHAR(255), 
    "dob" DATE, 
    "documentIds" VARCHAR(255)[], 
    "passportId" INTEGER REFERENCES "passport3" ("id") ON DELETE NO ACTION ON UPDATE CASCADE, 
    "livingAddressId" INTEGER REFERENCES "testAdress3" ("id") ON DELETE NO ACTION ON UPDATE CASCADE, 
    "regAddressId" INTEGER REFERENCES "testAdress3" ("id") ON DELETE NO ACTION ON UPDATE CASCADE, 
    "curWorkExp" VARCHAR(255) DEFAULT 0, "typeEducation" "public"."enum_client3_typeEducation", 
    "monIncome" VARCHAR(255) DEFAULT 0, "monExpenses" VARCHAR(255) DEFAULT 0, 
    "spouse" INTEGER, 
    "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, 
    "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, 
    "destroyTime" TIMESTAMP WITH TIME ZONE, PRIMARY KEY ("id")
...
Executing (default): SELECT i.relname AS name, ix.indisprimary AS primary, ix.indisunique AS unique, ix.indkey AS indkey, array_agg(a.attnum) as column_indexes, array_agg(a.attname) 
AS column_names, pg_get_indexdef(ix.indexrelid) AS definition FROM pg_class t, pg_class i, pg_index ix, pg_attribute a WHERE t.oid = ix.indrelid AND i.oid = ix.indexrelid AND a.attrelid = t.oid AND t.relkind = 'r' and t.relname = 'client3' GROUP BY i.relname, ix.indexrelid, ix.indisprimary, ix.indisunique, ix.indkey ORDER BY i.relname;
Executing (default): CREATE TABLE IF NOT EXISTS "child3" ("id"  SERIAL UNIQUE , "name" VARCHAR(255), "surname" VARCHAR(255), "patronymic" VARCHAR(255), "dob" DATE, "clientId" INTEGER, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "destroyTime" TIMESTAMP WITH TIME ZONE, PRIMARY KEY ("id"));
Executing (default): SELECT i.relname AS name, ix.indisprimary AS primary, ix.indisunique AS unique, ix.indkey AS indkey, array_agg(a.attnum) as column_indexes, array_agg(a.attname) 
